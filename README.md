...
Step4: Set The RCC External Clock Source STM32 RCC External Clock Selection CubeMX  
...
step10. After creation of the circuit as per requirement as shown below       
Step11. Double click on the the MCU part to open settings. Next to the Program File option, give full path to the Hex file generated using STM32Cube IDE. Then set the external crystal frequency to 8M (i.e. 8 
        MHz). Click OK to save the changes.  
Step12. click on debug and simulate using simulation as shown below   
```
## STM 32 CUBE PROGRAM :
```
/*
